#!/bin/bash
# ==============================================================================
# TRAINING PIPELINE FOR ai-lab1 — Contrastive VQ-VAE for Genomic Surveillance
# ==============================================================================
# Adapted from run_all_overnight.sh for ai-lab1.dyn.gsu.edu
# 6x RTX 4090 (24GB each), local conda env on NVMe
#
# Usage (on ai-lab1):
#   tmux new -s training
#   cd ~/projects/genomic_sequence_detection
#   bash scripts/run_all_ailab1.sh 2>&1 | tee training_log.txt
#
# Estimated total runtime: ~3-5 hours on 6x RTX 4090
# ==============================================================================
...
N_GPU=4
GPU_IDS="0,1,2,3"
BATCH_SIZE=48  # per-GPU batch for 24GB 4090s; effective = 48*4 = 192
SEED=42
...
echo "============================================================"
echo "  TRAINING PIPELINE (ai-lab1)"
echo "  Started: $(date)"
echo "  Host:    $(hostname)"
echo "  Data:    ${DATA_PATH}"
