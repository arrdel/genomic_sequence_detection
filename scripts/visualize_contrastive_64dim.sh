#!/bin/bash
#
# Visualize Contrastive Learning Relationships
#
...
#
# Usage:
#   ./scripts/visualize_contrastive_64dim.sh
...
echo "=========================================="
echo "Contrastive Learning Relationship Visualization"
echo "=========================================="
echo ""
...
OUTPUT_DIR="experiments/3_contrastive_vqvae/relationship_viz"
PROJ_DIM=64
NUM_SAMPLES=500
NUM_PAIRS=50
...
if [ ! -f "$CONTRASTIVE_CHECKPOINT" ]; then
    echo "ERROR: Contrastive checkpoint not found: $CONTRASTIVE_CHECKPOINT"
    echo "Please train the contrastive model first."
    exit 1
fi
